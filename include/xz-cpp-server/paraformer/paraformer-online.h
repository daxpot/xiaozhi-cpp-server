...
namespace funasr {
    ...
    */
    private:
        ...
        int OnlineLfrCmvn(std::vector<std::vector<float>> &wav_feats, bool input_finished);
        ...
        void InitOnline(
            ...
            std::vector<const char*> &en_szInputNames,
            std::vector<const char*> &en_szOutputNames,
            std::vector<const char*> &de_szInputNames,
            std::vector<const char*> &de_szOutputNames,
        ...
        std::vector<const char*> en_szInputNames_;
        std::vector<const char*> en_szOutputNames_;
        std::vector<const char*> de_szInputNames_;
        std::vector<const char*> de_szOutputNames_;
    ...
    public:
        ...
        void ResetCache();
        void InitCache();
        void ExtractFeats(float sample_rate, std::vector<std::vector<float>> &wav_feats, std::vector<float> &waves, bool input_finished);
        void AddOverlapChunk(std::vector<std::vector<float>> &wav_feats, bool input_finished);
        
        std::string ForwardChunk(std::vector<std::vector<float>> &wav_feats, bool input_finished);
        std::string Forward(float* din, int len, bool input_finished, const std::vector<std::vector<float>> &hw_emb={{0.0}}, void* wfst_decoder=nullptr);
