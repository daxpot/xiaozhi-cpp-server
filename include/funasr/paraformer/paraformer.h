...
namespace funasr {
    ...
    */
    private:
        ...
        std::vector<std::string> hw_m_strInputNames, hw_m_strOutputNames;
        std::vector<const char*> hw_m_szInputNames;
        std::vector<const char*> hw_m_szOutputNames;
        bool use_hotword;
    ...
    public:
        ...
        std::string GreedySearch( float* in, int n_len, int64_t token_nums,
        ...
        std::vector<std::string> en_strInputNames, en_strOutputNames;
        std::vector<const char*> en_szInputNames_;
        std::vector<const char*> en_szOutputNames_;
        std::vector<std::string> de_strInputNames, de_strOutputNames;
